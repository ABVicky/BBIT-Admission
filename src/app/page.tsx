        ...
        <div className="container">
          <div className={styles.heroInner}>
            ...
            <div className={styles.heroBtns}>
              ...
              <a href="https://www.bbit.edu.in/" target="_blank" rel="noopener noreferrer" className="btn btn-primary btn-xl" style={{ background: "rgba(255,255,255,0.1)", backdropFilter: "blur(10px)", border: "1px solid rgba(255,255,255,0.2)" }}>
          ...
          <div className={styles.campusLayout}>
            ...
            <div className={styles.campusPhotoGrid}>
              <div className={`${styles.campusPhoto} ${styles.campusPhoto1}`}>
                {/* Image handled in CSS for better cover control */}
              </div>
